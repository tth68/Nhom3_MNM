		...
		<div class="col-md-4 col-12">
			...
			<ul class="list-unstyled">
				<li class="clearfix">
					...
					<span style="color: black"> Số nhà 6, Nguyên Xá, Bắc Từ Liêm, Hà Nội</span><br>
				</li>
				<li class="clearfix">
					<i class="fa fa-phone fa-1x" style="color:#0f9ed8;padding: 20px;  "></i>
					<span style="color: black">0974679000 - 09999999999</span>
				</li>
				<li class="clearfix">
					<i class="fa fa-envelope fa-1x " style="color:#0f9ed8; padding: 20px; "></i>
					<span style="color: black"><a href="mailto:daothithuy.27092001@gmail.com">daothithuy.27092001@gmail.com</a></span>
				</li>
			</ul>
		</div>
