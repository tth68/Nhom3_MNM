    ...
    <div class="container">
        <div class="col-xs-12 col-sm-12 col-md-6">
            <div class="col-xs-12 col-sm-6">
                <a href="trang-chu">
                    <img src="public/images/LOGO3.png" style="width: 100%;" class="img-fix f-logo" alt="smart-construction">
                </a>
                <div class="about-store">
                 Shop MYFASHION. Chất lượng tốt - Uy tín hàng đầu
             </div>
         </div>
         <div class="col-xs-12 col-sm-6">
            <div class="f-contact">
                ...
                <ul class="list-unstyled">
                    <li class="clearfix">
                        ...
                        <span>Số nhà 6, Nguyên Xá, Bắc Từ Liêm, Hà Nội</span>
                    </li>
                    <li class="clearfix">
                        <i class="fa fa-phone"></i>
                        <span>0914567890 - 0964764099</span>
                    </li>
                    <li class="clearfix">
                        <i class="fa fa-envelope"></i>
                        <span><a href="mailto:daothithuy.27092001@gmail.com">daothithuy.27092001@gmail.com</a></span>
                    </li>
                </ul>
            </div>
        </div>
