					...
					<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
						<div class="product-view-content">
								...
								<div id="km-detail">
									...
									<div class="fk-main">
										<div class="fk-sales">
											...
											<ul>
												<li>Tặng một chiếc điện thoại iphone 8s plus 64GBs (khi phiếu mua hàng trên 100,000,000 đ)</li>
											</ul>
											<!-- <ul>
											...
											<ul> 
												<li>Giảm thêm 99,000đ khi mua combo áo khoác và khăn quàng cổ lông cừu <a href="#" target="_blank">Xem chi tiết</a>
												</li>
											</ul>
										</div>
									</div>
							...
							<div style="margin-top: 20px;">
								<b>Tình trạng</b>
								<br>
								<span>Nguyên mới 100%. Đầy tem mác và giấy tờ liên quan của thương hiệu</span>
							</div>
							<div style="margin-top: 20px;">
								<b>Bảo hành</b>
								<br>
								<span>Bảo hành 1 tháng. Và 1 đổi 1 trong 30 ngày nếu có lỗi do cửa hàng gây ra.</span><a href="#" style="color:red"> (Chi tiết)</a>
							</div>
						</div>
					</div>
